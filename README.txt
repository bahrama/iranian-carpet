...
a persistence unit "carpetPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "carpet/pom.xml":
...
artifacts ("carpet-ejb.jar" and "carpet-web.war") are already built. You can build
